	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			if(pressedEnter)
			{
				...
				FlxTween.tween(logoBl, {y: -700}, 0.5);
				//FlxTween.tween(gfDance, {x: 1500}, 0.5);
				FlxTween.tween(titleText, {y: 1500}, 0.5);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(["This mod is by"], 15);
				case 6:
					addMoreText('Symple', 15);
